...
export const CityApi = {
  ...
  searchCitiesWithAreasCount: async function (searchParams, cancel = false) {
    // console.log(searchParams)
    const response = await api.request({
      url: "/cities/searchCitiesWithAreasCount",
      method: "GET",
      params: searchParams,
      signal: cancel ? cancelApiObject[this.searchCitiesWithAreasCount.name].handleRequestCancellation().signal : undefined,
    })
